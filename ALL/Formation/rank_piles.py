...
modify the input array to rank the piles from 1 to N, 
...
def rankPiles(piles: list[int]) -> list[int]:
    ...
    for pile in sorted_piles:
        rock_dict[pile] = place
        place += 1

    for x in piles:
        result.append(rock_dict[x])
...
print(rankPiles([1]))
print(rankPiles([2, 1]))
print(rankPiles([80, 27, 55, 30, 15, 90, 10]))

arr = [10, 8, 15, 12, 6, 20, 1]
print(rankPiles(arr) == [4, 3, 6, 5, 2, 7, 1])

print(rankPiles([]) == [])

arr = [1]
print(rankPiles(arr) == [1])

arr = [2, 1]
print(rankPiles(arr) == [2, 1])

arr = [3, 4, 1]
print(rankPiles(arr) == [2, 3, 1])

arr = [10, 15, 20]
print(rankPiles(arr) == [1, 2, 3])

arr = [20, 15, 10]
print(rankPiles(arr) == [3, 2, 1])

arr = [80, 27, 55, 30, 15, 90, 10]
print(rankPiles(arr) == [6, 3, 5, 4, 2, 7, 1])
