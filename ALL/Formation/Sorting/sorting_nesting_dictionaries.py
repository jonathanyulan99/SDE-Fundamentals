...
# equivalent with lambda function one liner
print(sorted(data.items(), key=lambda item: item[1]["skills"].get(
    "python", 0) + item[1]["skills"].get("js", 0), reverse=True))
